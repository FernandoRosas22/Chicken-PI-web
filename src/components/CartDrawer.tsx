  ...
  return (
    <AnimatePresence>
      {isOpen && (
        <>
          <motion.div
            className="fixed inset-0 z-50 bg-coal/50 backdrop-blur-sm"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            onClick={onClose}
          ...
          <motion.div
            ...
            className="fixed top-0 right-0 z-50 h-full w-full sm:w-96 bg-cream flex flex-col shadow-2xl"
          >
              ...
              {items.length === 0 ? (
                ...
                <ul className="space-y-4">
                  {items.map((item) => (
                    <li
                      key={item.product.id}
                      className="flex gap-3 items-start border-b border-coal/5 pb-4"
                    >
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-2 mt-2">
                          ...
                          <button
                            ...
                            className="text-xs text-coal/40 hover:text-chili underline"
                          >
                            Quitar
                          </button>
                        </div>
              ...
              <div className="p-5 border-t border-coal/10 shrink-0">
                ...
                {!checkoutOpen ? (
                  <button
                    ...
                    className="w-full bg-ember hover:bg-chili transition-colors text-cream font-bold py-3.5 rounded-xl"
                  >
                    Continuar pedido
                  </button>
                ) : (
